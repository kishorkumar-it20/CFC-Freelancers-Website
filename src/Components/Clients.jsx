    ...
    return (
        <div className="bg-gray-100 pb-10">
            <div className="flex flex-col md:flex-row m-10 ml-52 justify-between">
                <h1 className="font-poppins text-3xl mt-14">High Rated Clients</h1>
                ...
                {clients.map((client, index) => (
                    <div key={index} className="w-98 h-98 bg-white rounded shadow-2xl mt-10 ml-20 justify-center">
                        <div className="flex ml-10"> 
                            <img src={client.image} alt="" className="w-40 h-40 rounded-full mt-16 blur-sm ml-24" />
                            <MdStars className="size-12 text-gray-400 ml-7 mt-12"/>
                        </div>
                        <div className="mt-10 flex flex-col items-center"> 
                            <div className="flex justify-center">
                                <h1 className="font-poppins text-xl">{client.name}</h1>
                                <img src={client.countryFlag} alt="" className="w-6 h-4 rounded-sm ml-2 mt-2"/>
                            </div>
                            <h4 className="font-poppins text-gray-500 mt-3 text-2xl">{client.profession}</h4>
                        </div>
                        <div className="flex justify-center mt-5">
                            {Array.from({ length: client.stars }, (_, i) => (
