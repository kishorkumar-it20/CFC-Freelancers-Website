    ...
    return (
        <div className='pb-10'>
            <div className="text-center">
                <h2 className="font-poppins text-2xl mt-4">Yearly Membership</h2>
                <p className="font-poppins mt-2">Details about the Yearly membership plan.</p>
            </div>
                ...
                <div className='relative w-96 h-97 bg-white rounded shadow-xl border border-gray-300'>
                    <div className='absolute ml-10'>
                        ...
                        <div className='relative w-72 h-16 bg-gray-200 rounded mt-5 flex justify-center items-center'>
                            <h1 className='font-poppins text-xl'>$205/Year</h1>
                        </div>
